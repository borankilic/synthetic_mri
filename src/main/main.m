function main()
    ...
    runRomeo(cfg.paths.im_mag_dir, cfg.paths.im_phase_dir, cfg.params.real_echo_times, cfg.paths.output_dir, cfg.paths.patient_dir, cfg.paths.romeo_script_path);

    % Convert images to k-space
    nifti_to_kspace(cfg.paths.output_dir , 'fft_shift', true, 'normalize', true);
